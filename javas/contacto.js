...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const validarFormulario = () => {
        ...
        validar = validarCampo('nombre', 'Ingresa tu nombre') && validar;
        validar = validarCampo('apellido', 'Ingresa tu apellido') && validar;
        validar = validarCampo('mensaje', 'Ingresa tu consulta') && validar;
        return validar;
    }
